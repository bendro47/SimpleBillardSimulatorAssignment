...
public class GameManager : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            var ballPos = new Vector3(WhiteBall.transform.position.x, 0.0f, WhiteBall.transform.position.z);
            var mousePos = new Vector3(hit.point.x, 0.0f, hit.point.z);
        ...
        if (!line.gameObject.activeSelf && WhiteBall.GetComponent<Rigidbody>().velocity.magnitude < 0.0f)
        {
